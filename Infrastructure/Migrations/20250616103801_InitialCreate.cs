        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Book_Copies", "[AvailableCopies] >= 0 AND [AvailableCopies] <= [TotalCopies]");
                    table.CheckConstraint("CK_Book_ReservedCopies", "[ReservedCopies] >= 0 AND [AvailableCopies] + [ReservedCopies] <= [TotalCopies]");
                    table.CheckConstraint("CK_Book_TotalCopies", "[TotalCopies] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Category_NoSelfReference", "[Id] != [ParentCategoryId]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutstandingFines = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CurrentLoanCount = table.Column<int>(type: "int", nullable: false),
                    CurrentReservationCount = table.Column<int>(type: "int", nullable: false),
                    NotificationPreference = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Member_LoanCount", "[CurrentLoanCount] >= 0 AND [CurrentLoanCount] <= 5");
                    table.CheckConstraint("CK_Member_ReservationCount", "[CurrentReservationCount] >= 0 AND [CurrentReservationCount] <= 3");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverdueFine = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Loan_Dates", "[DueDate] > [LoanDate]");
                    table.CheckConstraint("CK_Loan_OverdueFine", "[OverdueFine] IS NULL OR [OverdueFine] >= 0");
                    table.CheckConstraint("CK_Loan_RenewalCount", "[RenewalCount] >= 0 AND [RenewalCount] <= 2");
                    table.CheckConstraint("CK_Loan_ReturnDate", "[ReturnDate] IS NULL OR [ReturnDate] >= [LoanDate]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Reservation_QueuePosition", "[QueuePosition] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WaiverReason = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Fine_AmountPaid", "[AmountPaid] >= 0 AND [AmountPaid] <= [Amount]");
                    table.ForeignKey(
