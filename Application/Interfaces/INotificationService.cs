...
public interface INotificationService
{
    ...
    Task<Common.Result<int>> MarkAsReadAsync(NotificationMarkAsReadDto dto, int memberId);
    ...
    Task<Common.Result<int>> SendOverdueNotificationsAsync(); // For scheduled job
    Task<Common.Result<int>> SendAvailabilityNotificationsAsync(); // For scheduled job
}
